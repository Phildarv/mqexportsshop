...
import {CartItem} from '../../Components/ProductItem.component';
...
const Checkout = (props: Props): JSX.Element => (
  <ScrollView>
    {props.products.length > 0 ? (
      ...
      <Text style={styles.textEmpty}>You have not orderd any items</Text>
    )}
  </ScrollView>
);
